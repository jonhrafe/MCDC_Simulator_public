...
#ifndef SIMULABLESEQUENCECUDA_CUH
#define SIMULABLESEQUENCECUDA_CUH
#include <string>
#include <vector>
#include "walker.h"
...
public:
    ...
    double *grad_sequence; 

    double *phase_shift_cuda;

    double *DWI_cuda;


    SimulableSequenceCuda(){}

    virtual ~SimulableSequenceCuda(){}
    ...
    /**
     * @param i: updated the phase and signal shift over a whole trajectory
     */
